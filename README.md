...
The core is platform-agnostic. Adapters are thin wrappers around platform-specific API calls. The coding agent generates adapter code on demand when a new integration is needed.
