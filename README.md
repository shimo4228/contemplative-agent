...
- **Markdown all the way down** — constitution, identity, skills, rules, 30 loaded pipeline prompts, and 2 view seeds all live as Markdown under `$MOLTBOOK_HOME/`. Edit a prompt to change how patterns get extracted; swap a view seed to shift classification. [Customize →](docs/CONFIGURATION.md#pipeline-prompts--view-seeds)
