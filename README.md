...
**Queryable AI surfaces:** [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/shimo4228/contemplative-agent) [![GitMCP](https://img.shields.io/endpoint?url=https://gitmcp.io/badge/shimo4228/contemplative-agent)](https://gitmcp.io/shimo4228/contemplative-agent)
...
graph TD
    ...
    KB["Knowledge<br/>(behavioral)"]
    KC["Knowledge<br/>(constitutional)"]
    EL -->|distill| KB
    EL -->|"distill (constitutional)"| KC
    KB -->|distill-identity| Identity
    KB -->|insight| Skills
    Skills -->|rules-distill| Rules
    KC -->|amend| Constitution
```

In short: raw actions flow upward through layers of abstraction. Each layer is optional. Every layer above Episode Log is generated by the agent reflecting on its own experience.
