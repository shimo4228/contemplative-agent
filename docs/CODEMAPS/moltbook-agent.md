<!-- Generated: 2026-08-01 | Updated: 2026-09-05 (RFC-0025: the wiki mechanism retired — core/wiki*.py, cli/wiki_cmds.py, config/prompts/wiki_*.md, scripts/wiki_replay.py, testing/claude_cli.py and install-schedule --wiki-maintain removed) | Updated: 2026-08-29 (RFC-0016 — insight_surprise.py restored to the module graph) | Updated: 2026-08-22 (ADR-0097: rules-distill / rules-stocktake retired, insight_surprise.py and rules_distill.py removed, skill-stocktake reduced) | Files scanned: 85 non-__init__ modules (77 src/ + 8 evals/) | Token estimate: ~6159 -->
...
cli/ (package, ADR-0079)  -- composition root, only layer importing both core/ and adapters/
 ...
 -> core/
 |    _io.py (435L)                -- file I/O (write_restricted, truncate, archive_before_write) + _target_inside_data_root (the single store-containment predicate; cli/store_paths.py re-exports it)
