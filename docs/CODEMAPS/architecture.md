...
Stage 8 packet:    build_decision_packet.py → weekly-<end>-packet.md (§2 fix table +
                   ...
                   reads at the gate. Which renderer applies where:
                     ...
                     values that become filenames . _log_segment (no `/`)
                   Scope and rationale live in _cell's and _log_segment's
                   docstrings and in Rendering discipline below — not restated
                   here (2026-08-16, T-PACKET-FLOOR-BYPASS).
