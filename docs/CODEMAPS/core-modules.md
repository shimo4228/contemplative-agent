<!-- Generated: 2026-08-01 | Updated: 2026-08-25 (skill_selection.py split: the pass-1 selector keeps the name, its two read-only instruments move to selection_metrics.py / never_selected_metrics.py over the shared selection_window.py) | Files scanned: 33 core modules | Token estimate: ~4161 -->
