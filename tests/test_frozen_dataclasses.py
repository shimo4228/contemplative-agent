...
ALLOWED_MUTABLE = {
    ...
    # Same shape again: the window-wide collections and counters
    # _scan_selection_day folds each day into, internal to
    # read_skill_selection_log and read only to build the frozen
    # SkillSelectionReading. They live in one object rather than a dozen
    # parameters — carrying them individually is what made the scanner an
    # eight-argument function (2026-08-31).
